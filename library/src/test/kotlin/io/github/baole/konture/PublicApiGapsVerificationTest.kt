    ...
    fun `test files reified and structural methods`() {
        assertDoesNotThrow {
            FilesRuleBuilder(projectGraph)
                ...
                .and().inModule(":library")
                .and().inModules(":library", ":core")
                .and().notInPackage("com.forbidden..")
                .and().notInModule(":forbidden")
                .and().notInModule(":forbidden")
                .and().notInModules(":forbidden", ":other")
                .and().notNamed("Forbidden.kt")
                .and().notNameMatches("*Forbidden*")
                .and().notNameStartsWith("Forbidden")
                .and().notNameEndsWith("Forbidden.kt")
            FilesRuleBuilder(projectGraph)
                .should().containClassesWithAnnotation<Test>()
                ...
                .andShould().inModule(":library")
                .andShould().inModules(":library", ":core")
                .andShould().notInModule(":app")
                .andShould().notInModules(":app", ":web")
                .andShould().named("PublicApiGapsVerificationTest.kt")
                .andShould().notNamed("Forbidden.kt")
                .andShould().notNameMatches("*Forbidden*")
                .andShould().notNameStartsWith("Forbidden")
                .andShould().notNameEndsWith("Forbidden.kt")
    ...
    fun `test classes reified usage subtyping and module location assertions`() {
        assertDoesNotThrow {
            ClassesRuleBuilder(projectGraph)
                ...
                .and().annotatedWith<Test>()
                .and().inModule(":library")
                .and().inModules(":library", ":core")
                .and().named("PublicApiGapsVerificationTest")
                .and().notNamed("Forbidden")
                .and().notNameMatches("*Forbidden*")
                .and().notNameStartsWith("Forbidden")
                .and().notNameEndsWith("Forbidden")
                .and().notInPackage("com.forbidden..")
                .and().notInModule(":forbidden")
            ...
            ClassesRuleBuilder(projectGraph)
                ...
                .andShould().named("PublicApiGapsVerificationTest")
                .andShould().notNamed("Forbidden")
                .andShould().notNameMatches("*Forbidden*")
                .andShould().notNameStartsWith("Forbidden")
                .andShould().notNameEndsWith("Forbidden")
