...
open class ClassesShouldAssertionsTest : RuleBuildersTestBase() {
    ...
    fun `test classes assertions`() {
        ...
        val assertAllAnnotList = builder().should().annotatedWithAllOf(listOf("MyAnnotation")).getShouldAssertion()!!
        val vA7 = mutableListOf<String>()
        assertAllAnnotList(annotatedClass, emptyList(), vA7)
        assertTrue(vA7.isEmpty())

        val assertAllAnnotVararg = builder().should().annotatedWithAllOf("MyAnnotation").getShouldAssertion()!!
        ...
        val assertAnyAnnotList =
            builder().should().annotatedWithAnyOf(
