...
class FunctionsThat internal constructor(
    ...
    inline fun <reified T : Any> haveExtensionReceiver(): FunctionsRuleBuilder = haveExtensionReceiver(T::class)
    ...
    inline fun <reified T : Any> haveParameterOf(): FunctionsRuleBuilder = haveParameterOf(T::class)
    ...
    infix fun haveParameterOf(types: List<KClass<*>>): FunctionsRuleBuilder =
    ...
    infix fun notHaveParameterOf(typeFqName: String): FunctionsRuleBuilder {
        builder.setThat { func ->
            func.declaration.parameters.none {
                    p ->
                p.type == typeFqName || p.type.endsWith(".$typeFqName") || typeFqName.endsWith(".${p.type}")
            }
        }
