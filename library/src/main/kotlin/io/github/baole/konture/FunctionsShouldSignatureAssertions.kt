...
/** Asserts that selected functions have the specified raw return type. */
public inline fun <reified T : Any> FunctionsShould.haveReturnTypeOf(): FunctionsRuleBuilder = haveReturnType(T::class)

/** Asserts that selected functions have a parameter of raw type [T]. */
public inline fun <reified T : Any> FunctionsShould.haveAnyParameterTypeOf(): FunctionsRuleBuilder =
