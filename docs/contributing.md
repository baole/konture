...
This will publish the modules with version `0.8.0`:
- `io.github.baole:konture-core:0.8.0` (shared core data models)
- `io.github.baole:konture:0.8.0` (primary public API library)
- `io.github.baole.konture:plugin-gradle:0.8.0` (Gradle plugin)
